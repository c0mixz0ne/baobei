<template>
  <section class="service">
    <h2>Наши услуги</h2>
    <h3>
      У нас вы найдете все услуги, необходимые для гармоничного и всестороннего развития личности
      ребенка и подростка
    </h3>
    <ContainerComponent>
      <ul>
        ...
        <li>
          <div class="card">
            ...
            <div class="card-content">
              ...
              <p>
                Дошкольная подготовка - это фундамент, на котором строится будущее ребенка. Она
        ...
        <li>
          <div class="card">
            ...
            <div class="card-content">
              ...
              <p>
                Подготовка к экзаменам помогает преодолеть испытание знаниями, развивает нашу силу
