        ...
        <ProgramComponent class="rtl">
            <div class="content">
                ...
                <ul>
                    ...
                    <li>
                        Размер групп: 3-8 человек, что позволяет продуктивно проводить занятия
                    </li>
                    <li>
                    ...
                    <li>
                        Зачисление на уровни проводится по результатам бесплатного тестирования
                    </li>
                    <li>
                        Абонемент от 4900 за 8 занятий
                    </li>
                </ul>
            </div>
            <div class="image">
        ...
        <ProgramComponent class="rtl">
            <div class="content">
                ...
                <ul> 
                    ...
                    <li> 
                        Размер групп: 3-6 человек, что позволяет продуктивно проводить занятия 
                    </li> 
                    <li> 
                        Преподаватели со стажем работы и высокой языковой квалификацией 
                    </li> 
